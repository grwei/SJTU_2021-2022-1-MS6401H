...
for idx_ = 1:length(HW1_1_SOURCE_FILENAME)
    ...
    hw1_1_fig(source_full_path,HW1_1_VAR_NAME(idx_),HW1_1_VAR_UNIT(idx_),HW1_1_FIG_TITLE(idx_));
end

%% 局部函数

function [] = hw1_1_fig(source_full_path,var_name,var_unit,fig_title)
%1-1
    arguments
